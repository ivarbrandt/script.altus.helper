...
class Service(xbmc.Monitor):
    ...
    def _initialize(self):
        ...
        self.ratings_monitor = RatingsMonitor(
            RatingsDatabase(),
            self.home_window
        )
...
#                 self.waitForAbort(0.2)
#                 continue
#             current_imdb_id = self.get_infolabel(
#                 "ListItem.IMDBNumber"
#             ) or self.get_infolabel("ListItem.Property(imdb)")
#             current_tmdb_id = self.get_infolabel(
...
#                 target=self._fetch_ratings_thread, args=(api_key, imdb_id)
#             )
