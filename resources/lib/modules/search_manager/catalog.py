...
def _entry(
    ...
    kind,
    url_template,
    display_type="WidgetListSmallPoster",
    target="videos",
    is_stacked=0,
    stacked_type=None,
    label_override=None,
...
CATALOG = [
    # --- LIBRARY -------------------------------------------------------------
    _entry(None, "LIBRARY", "Movies", _LIB % "movies", display_type="WidgetListPoster"),
    _entry(
        None, "LIBRARY", "TV Shows", _LIB % "tvshows", display_type="WidgetListPoster"
    ),
    _entry(
        None, "LIBRARY", "Seasons", _LIB % "seasons", display_type="WidgetListPoster"
    ),
    _entry(
        None,
        "LIBRARY",
    ...
    _entry(
        ...
        "FEN",
        "Collections",
        "plugin://plugin.video.fen/?mode=build_movie_list&action=tmdb_movies_search_sets&query="
        + _Q,
    ),
    _entry(
        "plugin.video.fen",
    ...
    _entry(
        ...
        "FEN",
        "Keywords (Movies)",
        "plugin://plugin.video.fen/?mode=build_movie_list&action=imdb_keywords_list_contents&list_id="
        + _Q,
    ),
    _entry(
        "plugin.video.fen",
        "FEN",
        "Keywords (TV Shows)",
        "plugin://plugin.video.fen/?mode=build_tvshow_list&action=imdb_keywords_list_contents&list_id="
        + _Q,
    ),
    _entry(
        "plugin.video.fen",
        "FEN",
        "Trakt Lists",
        "plugin://plugin.video.fen/?mode=trakt.list.search_trakt_lists&query="
        + _Q_TRAKT,
    ...
    _entry(
        ...
        "FEN LIGHT",
        "Movies",
        "plugin://plugin.video.fenlight/?mode=build_movie_list&action=tmdb_movies_search&query="
        + _Q,
    ),
    _entry(
        "plugin.video.fenlight",
        "FEN LIGHT",
        "TV Shows",
        "plugin://plugin.video.fenlight/?mode=build_tvshow_list&action=tmdb_tv_search&query="
        + _Q,
    ),
    _entry(
        "plugin.video.fenlight",
        "FEN LIGHT",
        "Anime",
        "plugin://plugin.video.fenlight/?mode=build_tvshow_list&action=tmdb_anime_search&query="
        + _Q,
    ),
    _entry(
        "plugin.video.fenlight",
    ...
    _entry(
        ...
        "FEN LIGHT",
        "Keywords (Movies)",
        "plugin://plugin.video.fenlight/?mode=build_movie_list&action=tmdb_movie_keyword_results_direct&key_id="
        + _Q,
    ),
    _entry(
        "plugin.video.fenlight",
        "FEN LIGHT",
        "Keywords (TV Shows)",
        "plugin://plugin.video.fenlight/?mode=build_tvshow_list&action=tmdb_tv_keyword_results_direct&key_id="
        + _Q,
    ),
    _entry(
        "plugin.video.fenlight",
        "FEN LIGHT",
        "Trakt Lists",
        "plugin://plugin.video.fenlight/?mode=trakt.list.search_trakt_lists&query="
        + _Q_TRAKT,
        display_type="WidgetListCategoryStacked",
        is_stacked=1,
        stacked_type="WidgetListLandscape",
    ...
    _entry(
        ...
        "UMBRELLA",
        "Trakt Lists",
        "plugin://plugin.video.umbrella/?action=trakt_search_lists&media_type=movies&name="
        + _Q_TRAKT,
        display_type="WidgetListCategoryStacked",
        is_stacked=1,
        stacked_type="WidgetListLandscape",
    ...
    _entry(
        ...
        "UMBRELLA",
        "Trakt Lists",
        "plugin://plugin.video.umbrella/?action=trakt_search_lists&media_type=tvshows&name="
        + _Q_TRAKT,
        display_type="WidgetListCategoryStacked",
        is_stacked=1,
        stacked_type="WidgetListLandscape",
    ...
    _entry(
        ...
        "POV",
        "Collections",
        "plugin://plugin.video.pov/?mode=build_movie_list&action=tmdb_movies_search_collections&query="
        + _Q,
    ),
    _entry(
        "plugin.video.pov",
        "POV",
        "People",
        "plugin://plugin.video.pov/?mode=get_search_term&search_type=people&query="
        + _Q,
    ),
    _entry(
        "plugin.video.pov",
        "POV",
        "Keywords (Movies)",
        "plugin://plugin.video.pov/?mode=imdb_build_keyword_results&media_type=movie&query="
        + _Q,
    ),
    _entry(
        "plugin.video.pov",
        "POV",
        "Keywords (TV Shows)",
        "plugin://plugin.video.pov/?mode=imdb_build_keyword_results&media_type=tvshow&query="
        + _Q,
    ),
    _entry(
        "plugin.video.pov",
        "POV",
        "Trakt Lists",
        "plugin://plugin.video.pov/?mode=build_trakt_list.search_trakt_lists&search_title="
        + _Q_TRAKT,
        display_type="WidgetListCategoryStacked",
        is_stacked=1,
        stacked_type="WidgetListLandscape",
